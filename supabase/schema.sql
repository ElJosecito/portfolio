...
-- Experiencia laboral (solo si la tabla está vacía). Las fechas de los puestos
-- en curso van en NULL: el contenido original decía "Actualmente..." y no hay
-- fecha de inicio que copiar sin inventarla.
