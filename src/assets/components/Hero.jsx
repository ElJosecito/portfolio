...
function Hero() {
  ...
  const [text] = useTypewriter({
    words: [
      ...
      "SOY FRONTEND DEVELOPER EN TECNOLOGIAS COMO:",
      "HTML, CSS, JAVASCRIPT, REACT ENTRE OTROS",
  ...
  return (
    <>
      <section id="hero" className="w-full bg-[#22333b] flex justify-center">
        <div className="min-h-screen h-fit max-w-screen-2xl w-full">
          <div className=" w-full h-screen flex items-center justify-center relative">
            ...
            <div className="w-full h-screen flex flex-col justify-center absolute">
              ...
              <p className="font-nusar text-white w-full text-center h-1 tracking-wider text-xs" data-aos="fade-up"
                data-aos-duration="2000">
                {text}
              </p>
            </div>
      ...
      >
        <div className="h-fit max-w-screen-xl w-full">
          <h2 className="text-3xl tracking-[0.4rem] font-frank my-5 text-center md:text-start mx-4 text-[#ffb703]" data-aos="fade-right"
                data-aos-duration="500">
            Sobre Mi
          </h2>
          <div className="w-full flex flex-col md:flex-row">
            <div className="px-4 max-w-2xl">
              <p className="py-6 md:text-start font-thin text-center mt-4 md:mt-0 text-white font-nusar" data-aos="fade-right"
                ...
                <br />
                <br />
                Tengo experiencia en HTML, CSS y JavaScript y React, estoy en
              ...
              <div className="text-white flex flex-wrap justify-center md:justify-start">
                <div className="group ml-0 m-4 w-14 h-14 flex justify-center items-center bg-[#ffb703] rounded-full "
                data-aos="fade-up"
                data-aos-anchor-placement="center-bottom"
                ...
                <div className=" m-4 w-14 h-14 flex justify-center items-center bg-[#ffb703] rounded-full" data-aos="fade-up"
                data-aos-anchor-placement="center-bottom"
                ...
                <div className="m-4 w-14 h-14 flex justify-center items-center bg-[#ffb703] rounded-full"
                data-aos="fade-up"
                data-aos-anchor-placement="center-bottom"
            ...
            <div className="flex justify-center items-center w-full">
              <div className=" hidden md:block">
                <FontAwesomeIcon icon={faCode} className="text-[10rem] text-[#ffb703] animate-bounce"/>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="h-fit max-w-screen-xl w-full">
          <div className="flex items-center">
            <div className="border-b-2 border-[#ffb703] w-5 md:w-10 ml-4"
            data-aos="fade-right"
            data-aos-duration="800"></div>
            <p className="self-start text-base tracking-[0.4rem] font-frank my-5 text-center md:text-start mx-4 text-[#ffb703]" data-aos="fade-right"
            data-aos-duration="500">
              Portafolio
            </p>
          </div>
          <h2 className="text-3xl tracking-[0.4rem] font-frank my-5 text-center md:text-start mx-4 text-[#023047]"
          data-aos="fade-right"
          data-aos-duration="800">
            Proyectos
          </h2>
          <div className="w-full flex flex-col">
            {/*  */}
            <div className="border-4 border-[#ffb703] bg-[#023047] p-4 rounded-lg m-3 lg:flex" data-aos="fade-up"
            data-aos-duration="500">
              <div className="flex items-center" >
                <img src={banklanding} alt="" className="lg:max-w-lg" />
              </div>
              <div className="w-full lg:p-10 flex flex-col justify-between ">
                ...
                <p className="text-white mb-  text-xs sm:text-base">
                  Este es un landing page de un banco ficticio, desarrollado en
                  react y usando tailwindcss para los estilos, cuenta con un
                  diseñototalmente responsive y animaciones que hacen su uso mas
                  agradable.
                </p>
                <a
                  href="https://vermillion-kashata-e30b59.netlify.app"
                  target="_blank"
                >
            ...
            data-aos-duration="500">
              ...
              <div className="w-full lg:p-10 flex flex-col justify-between ">
                ...
                <p className="text-white mb-3 text-xs sm:text-base">
                  Esta Es una aplicacion la cual te permite buscar paises y
                  conocer sus datos mas importantes, esta fue desarrollada en
                  react, usando tailwindcss para los estilos y consumiendo una
                  api para buscar los datos de los paises, cuenta son filtros
                  para buscar por continente y por nombre.
                </p>
                <a
                  href="https://guileless-daffodil-25c071.netlify.app"
                  target="_blank"
                >
                  <button className="bg-[#219ebc] hover:bg-[#2b7183] transition-all duration-200 sm:w-32 mt-2 w-24 p-1 sm:p-2 text-white  rounded-full">
                    Ver Mas
            ...
            data-aos-duration="500">
              ...
              <div className="w-full lg:p-10 flex flex-col justify-between ">
                ...
                <p className="text-white mb-3  text-xs sm:text-base">
                  Este es un CRUD de notas totalmente completo y funcional, este
                  ha sido desarrollado en el ambiente MERN es decir usando Node,
                  express, React y MongoDB. En este podemos crear notas,
                  actualizar, editar y ver las notas borradas y restaurarlas.
                </p>
                <a
                  href="https://github.com/ElJosecito/Simple-Note-App"
                  target="_blank"
                >
                  <button className="bg-[#219ebc] hover:bg-[#2b7183] transition-all duration-200 sm:w-32 mt-2 w-24 p-1 sm:p-2 text-white  rounded-full">
                    Ver Mas
